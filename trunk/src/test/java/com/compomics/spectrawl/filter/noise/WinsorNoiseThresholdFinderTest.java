...
public class WinsorNoiseThresholdFinderTest {
    ...
    @Autowired
    private WinsorNoiseThresholdFinder noiseThresholdFinder;
    ...
    public void testWinsorNoiseTresholdFinder_1() {
        double threshold = noiseThresholdFinder.findNoiseThreshold(values_1);
    ...
    public void testWinsorNoiseTresholdFinder_2() {
        double threshold = noiseThresholdFinder.findNoiseThreshold(values_2);
    ...
    public void testWinsorNoiseTresholdFinder_3() {
        double threshold = noiseThresholdFinder.findNoiseThreshold(values_3);
